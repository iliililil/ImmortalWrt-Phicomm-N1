...
add_plugin_group "iliililil/CloudRunFilesBuilder#AdGuardHome" "AdGuardHome.run"
...
case "$PLUGINS" in
    *daed*)
        add_plugin_group "iliililil/CloudRunFilesBuilder#luci-app-daed" "luci-app-daed.run"
        echo "✅ 已选择 daed 组件"
        ;;
esac
